...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-111949679-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-111949679-1');
	</script>
...
'https://connect.facebook.net/en_US/fbevents.js');
 fbq('init', '243004326268557'); 
fbq('track', 'PageView');
</script>
<noscript>
 <img height="1" width="1" 
src="https://www.facebook.com/tr?id=243004326268557&ev=PageView
&noscript=1"/>
</noscript>
