			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        ...
                        "description" => __("Use background repeat", "themerex"),
                        "class" => "",
                        "value" => array(__('Fluid columns', 'themerex') => 'yes'),
                        "type" => "checkbox"
                    ),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "title",
						"heading" => __("Title", "themerex"),
						"description" => __("Title to be displayed when hovering on the marker", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => __("Description to be displayed when clicking on the marker", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
...
*/
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "data_hover",
                        "heading" => __("Data hover", "themerex"),
                        "description" => __("Title hover effect", "themerex"),
                        "class" => "",
                        "value" => "",
                        "type" => "textarea"
                    ),
//                    array(
//                        "param_name" => "open",
//                        "heading" => __("Show data-hover", "themerex"),
//                        "description" => __("Show hover", "themerex"),
//                        "class" => "",
//                        "value" => array("Show" => "yes" ),
//                        "type" => "checkbox"
//                    ),
					array(
						"param_name" => "type",
					...
					$THEMEREX_GLOBALS['vc_params']['class'],
					$THEMEREX_GLOBALS['vc_params']['animation'],
                    //$THEMEREX_GLOBALS['vc_params']['data-hover'],
					$THEMEREX_GLOBALS['vc_params']['css']
				),
				'js_view' => 'VcTrxTextView'
			) );
