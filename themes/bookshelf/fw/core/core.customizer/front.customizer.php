			...
			<div class="sc_scroll_slide swiper-slide">
				...
				<div class="co_section">
					...
					<div class="co_switch_box co_switch_horizontal co_switch_columns_3<?php /* co_switch_vertical|horizontal,co_switch_columns_3|4 */ ?>" data-options="body_style">
						...
						<a href="#" data-value="fullscreen"><?php _e('Fullscreen', 'themerex'); ?></a>
					</div>
				</div>
				...
				<div class="co_section">
					...
					<div class="co_colorpic_list">
						<div class="iColorPicker" data-options="link_color" data-value="<?php echo esc_attr($link_color); ?>"><span><?php _e('Link color', 'themerex'); ?></span></div>
						<div class="iColorPicker" data-options="menu_color" data-value="<?php echo esc_attr($menu_color); ?>"><span><?php _e('Menu color', 'themerex'); ?></span></div>
