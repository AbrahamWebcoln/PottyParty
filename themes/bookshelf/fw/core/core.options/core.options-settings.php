...
if ( !function_exists( 'themerex_options_settings_theme_setup' ) ) {
	...
	function themerex_options_settings_theme_setup() {
		...
		"footer_copyright" => array(
					...
					"override" => "category,courses_group,page,post",
					"std" => "ThemeREX &copy; 2016 All Rights Reserved ",
					"rows" => "10",
					"type" => "editor"),
		...
		"googlemap_title" => array(
					"title" => __("Marker's title",  'themerex'),
		...
		"googlemap_description" => array(
					"title" => __("Marker's description",  'themerex'),
		...
		"twitter_token_secret" => array(
            ...
            "info_socials_4" => array(
                "title" => __('Login via Social network', 'themerex'),
                "desc" => __("Settings for the Login via Social networks", 'themerex'),
                "type" => "info"),

            "social_login" => array(
                "title" => __('Social plugin shortcode',  'themerex'),
                "desc" => __('Social plugin shortcode like [plugin_shortcode]',  'themerex'),
                "divider" => false,
                "std" => "",
                "type" => "text"),
