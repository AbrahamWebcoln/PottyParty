...
if (!function_exists('themerex_action_add_styles_education')) {
	...
	function themerex_action_add_styles_education() {
		...
		themerex_enqueue_style( 'themerex-skin-style', themerex_get_file_url('skins/bookshelf/skin.css'), array(), null );
	}
}
...
if (!function_exists('themerex_action_add_responsive_education')) {
	...
	function themerex_action_add_responsive_education() {
		if (file_exists(themerex_get_file_dir('skins/bookshelf/skin-responsive.css')))
			themerex_enqueue_style( 'theme-skin-responsive-style', themerex_get_file_url('skins/bookshelf/skin-responsive.css'), array(), null );
	}
}
...
if (!function_exists('themerex_action_add_scripts_education')) {
	...
	function themerex_action_add_scripts_education() {
		if (file_exists(themerex_get_file_dir('skins/bookshelf/skin.js')))
			themerex_enqueue_script( 'theme-skin-script', themerex_get_file_url('skins/bookshelf/skin.js'), array(), null );
		if (themerex_get_theme_option('show_theme_customizer') == 'yes' && file_exists(themerex_get_file_dir('skins/bookshelf/skin.customizer.js')))
			themerex_enqueue_script( 'theme-skin-customizer-script', themerex_get_file_url('skins/bookshelf/skin.customizer.js'), array(), null );
	}
}
