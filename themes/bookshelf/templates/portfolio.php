...
//									}
                                    ...
                                    <div class="post_info">
                                        <?php
										if ($post_data['post_type']=='courses') {
                                            $course_start = themerex_get_custom_option('date_start','',$post_data['post_id']);
                                            echo __('Starts on', 'themerex') . ' ' /*. $course_start*/ . "<span class='ann-date'>" . (date(get_option('date_format'), strtotime(empty($course_end) || themerex_is_inherit_option($course_end) || $course_end >= date('Y-m-d') ? $course_start : $course_end))) . "</span>";
                                        }
                                        ?>
                                    </div>
